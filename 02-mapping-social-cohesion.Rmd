...
La conceptualización de @jenson1998mapping ha sido un recurso de suma
...
@jenson2010defining plantea que han existido tres familias vinculadas al
...
Europe (organismo de la Unión Europea) señalaba explícitamente: *"Social
...
sociedad abierta y multicultural. No obstante, @jenson2010defining
...
cohesion ..." (citado por Jenson, 2010:5)
...
Si bien @jenson2010defining no entrega una definición propia de la
...
para lograr metas comunes" [@Jeannote2003]
...
1.  Pertenencia/aislamiento: esta dimensión es más o menos compartida
...
2.  Inclusión/exclusión: esta dimensión tiene un carácter institucional
    y en el mercado en particular como elemento central de la
    modernidad.

3.  Participación/no-involucramiento: la cohesión social requiere
...
4.  Reconocimiento/rechazo: se parte de la idea de que las sociedades
...
5.  Legitimidad/ilegitimidad: se señala que la intermediación necesaria
...
Con esto en mente, @jenson2010defining plantea tres set de indicadores.
...
1.  Cohesión social como inclusión social relacionada al acceso de
...
2.  Cohesión social como inclusión social relacionada la actividad
    económica:
...
3.  Cohesión social como inclusión social relacionada con el acceso a
...
4.  Cohesión social como inclusión social relacionada con el acceso a la
    salud:
...
5.  Cohesión social como inclusión social relacionada con el acceso a
    tecnología:
...
4.  Jenson, J., & Saint-Martin, D. (2003). New routes to social
